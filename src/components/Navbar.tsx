...
const Navbar = () => {
    ...
    return items.map((item) => {
      ...
      return (
        <Link
          ...
          className={`text-base  ${
            pathname === '/about'
              ? `font-normal text-[${colors.parchment1}] dark:text-[${colors.darkEmerald}]`
              : `font-light text-[${colors.parchment1}] dark:text-[${colors.darkEmerald}]`
          }`}
        >
          {pathname === href && '➺ '}
          {item}
  ...
  return (
    <div
      className={`fixed z-50 mx-auto h-16 w-[100%] bg-[${
        colors.parchment1
      }] px-4  transition-[top] duration-[0.6s] dark:bg-[#082630] ${
